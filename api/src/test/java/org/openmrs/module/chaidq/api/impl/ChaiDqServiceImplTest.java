...
package org.openmrs.module.chaidq.api.impl;
...
import org.openmrs.module.chaicore.test.TestUtils;
...
/**
 * Tests for {@link ChaiDqServiceImpl}
 */
public class ChaiDqServiceImplTest extends BaseModuleContextSensitiveTest {

	@Autowired
	private PatientService patientService;

	@Autowired
	private ChaiDqService chaiDqService;

	/**
	 * @see ChaiDqServiceImpl#mergePatients(org.openmrs.Patient, org.openmrs.Patient)
	 */
	@Test
	public void mergePatients_shouldMergePatientsNotLeavingDuplicateIds() {
		...
		chaiDqService.mergePatients(patient7, patient8);
